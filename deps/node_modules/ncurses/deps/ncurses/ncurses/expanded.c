...
{
 if (!((((*((SP)->_current_attr))).attr) == (((*c)).attr) && ((((*((SP)->_current_attr))).ext_color) ? (((*((SP)->_current_attr))).ext_color) : ((int)((((unsigned long)((((*((SP)->_current_attr))).attr)) & ((((1UL) << 8) - 1UL) << ((0) + 8))) >> 8)))) == ((((*c)).ext_color) ? (((*c)).ext_color) : ((int)((((unsigned long)((((*c)).attr)) & ((((1UL) << 8) - 1UL) << ((0) + 8))) >> 8)))))) { vid_attr((((*c)).attr), ((((*c)).ext_color) ? (((*c)).ext_color) : ((int)((((unsigned long)((((*c)).attr)) & ((((1UL) << 8) - 1UL) << ((0) + 8))) >> 8)))), 0); };
}
