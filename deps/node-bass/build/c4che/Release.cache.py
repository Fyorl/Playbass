...
CPPPATH_NODE = '/home/kim/projects/Playbass/deps/node-v0.6.10/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '../node-v0.6.10/include/node/'
LIBPATH_BASS = ['/home/kim/projects/Playbass/deps/node-bass/../bass/64-bit']
LIBPATH_NODE = '/home/kim/projects/Playbass/deps/node-v0.6.10/lib'
LIBPATH_ST = '-L%s'
LIB_BASS = ['bass']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '../node-v0.6.10/include/node/'
PREFIX = '/usr/local'
PREFIX_NODE = '/home/kim/projects/Playbass/deps/node-v0.6.10'
